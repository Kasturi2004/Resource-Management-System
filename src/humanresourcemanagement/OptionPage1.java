 ...
 */
public class OptionPage1 extends javax.swing.JFrame {

    /**
     * Creates new form OptionPage1
     */
    public OptionPage1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Book Your Seat");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Cancel1 Cancel1Frame = new Cancel1();
        Cancel1Frame.setVisible(true);
        Cancel1Frame.pack();
        Cancel1Frame.setLocationRelativeTo(null);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OptionPage1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OptionPage1().setVisible(true);
            }
        });
    }
